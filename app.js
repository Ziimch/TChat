...
let allRows=[],reactionMap={},listening=false,lastSent=0,cleanupRunning=false,replyTarget=null,unread=0,audioEnabled=localStorage.getItem("tchat-sound")!=="off";
...
function updateUnreadButton(){const b=$("#jumpBottom");b.hidden=unread===0;$("#unreadCount").textContent=unread}
function jumpBottom(){messages.scrollTop=messages.scrollHeight;unread=0;updateUnreadButton()}
